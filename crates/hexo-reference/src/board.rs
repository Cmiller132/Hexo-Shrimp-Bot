...
//! one; the dormant `serde` impls (which deserialize a bare cell list and
//! bypass turn rules) and the `place`/`debug_stones` helpers that only they and
//! the unit tests used were removed.
