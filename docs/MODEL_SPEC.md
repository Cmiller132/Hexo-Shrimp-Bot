...
The default configuration has 1,249,828 parameters: 1,063,648 in the four
trunk blocks and 186,180 across input/final parameters and the three heads.
...
legal cell in engine legal-move order. It owns a window projection, slot-class
