...
| [docs/KLENT_PROPOSALS.md](docs/KLENT_PROPOSALS.md) | An external suggestion set for strengthening KLENT on Hexo, restated in this repo's notation and reviewed item by item. Seven accepted, the rest rejected with reasons. |
