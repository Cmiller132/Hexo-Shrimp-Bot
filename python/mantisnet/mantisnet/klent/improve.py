...
def improved_policy(
    ...
    mass = segment_sum(probs, offsets)
    v_hat = segment_sum(probs * q, offsets) / mass
    kl = segment_sum(probs * (log_improved - log_pi), offsets) / mass
    entropy = segment_sum(-probs * log_improved, offsets) / mass
